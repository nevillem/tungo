...
String? validateNin(String value, String? msg1, String? msg2) {
  if (value.isEmpty) {
    return msg1;
  }
  if (value.length <=13) {
...
String? validateFqmilyPop(String value, String? msg1) {
  if (value.isEmpty) {
    return msg1;
  }
  return null;
...
String? getTimeCounter(String value, String? msg1, String? msg2) {
  msg1=("$msg1 $value $msg2");
    return msg1;
}
Widget getProgress() {
...
Map<String, String> get headers => {
      ...
      'Charset': 'utf-8',
      'Authorization': CUR_ACCESS.toString(),
};
Map refreshToken = {
