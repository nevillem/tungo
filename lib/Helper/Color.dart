...
extension colors on ColorScheme {
  ...
  static const Color primary = Color(0xFF73B41A);
  static const Color secondary = Color(0xffFDC994);
  // static const Color fontColor = Color(0xff4543C1);
  ...
  static const Color grad1Color = Color(0xffbeff69);
  static const Color grad2Color = Color(0xFF73B41A);
