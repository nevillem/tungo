...
//==============================================================================
  ...
  _deleteUserSession() async {
    ...
    if (avail) {
    Response sessionDelUrl = await delete(
        updateUserSessionApi, headers: headers).timeout(const Duration(seconds: timeOut));
    if((sessionDelUrl.statusCode==200)||(sessionDelUrl.statusCode==400)){
